...
#    Updated: 2017/07/10 17:50:55 by idemchen         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LEM_NAME = lem-in
GEN_NAME = map-generator
LEM_SRC	= lem_in.c lemin_algorithm.c lemin_atoi.c lemin_choose_path.c \
		lemin_get.c lemin_order_holes.c lemin_order_next.c \
		lemin_parse_ants.c lemin_parse_holes.c lemin_parse_links.c lemin_weak_functions.c
LEM_GEN = generator/lemin_map_generator.c
...
map:
	@echo "\033[1;34mlem_in\t\033[1;33mGenerating map...\t\033[0;32m[In process]\033[0m"
	@clang -o $(GEN_NAME) $(LEM_GEN) $(LIB_DYNAMIC)
	@echo "\033[1;34mlem_in\t\033[1;33mMap is generated\t\033[0;32m[Completed]\033[0m"
